...
import com.magic.maw.ui.common.ThumbSizeSlider
                    ...
                    .pointerInput(Unit) {
                        ...
                        detectTapGestures(
                            ...
                            onLongPress = {
                                ...
                                val videoSettings =
                                    SettingsStore.settings.videoSettings
...
class VideoPlayerState(
    isPlaying: Boolean = SettingsStore.settings.videoSettings.autoplay,
    ...
    fun changeVideoSource(uri: Uri) {
        ...
        exoPlayer.prepare()
        if (!exoPlayer.isPlaying && SettingsStore.settings.videoSettings.autoplay) {
            exoPlayer.play()
        }
        isReady.value = false
