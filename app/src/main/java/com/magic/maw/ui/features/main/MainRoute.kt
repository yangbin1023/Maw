...
sealed class AppRoute {
    ...
    @Serializable
    data class PostViewer(val postIndex: Int) : AppRoute()
    ...
    @Serializable
    data class PoolPost(val poolId: String) : AppRoute()

    @Serializable
    data class PoolViewer(val poolId: String, val postIndex: Int) : AppRoute()
    ...
    @Serializable
    data class PopularViewer(val postIndex: Int) : AppRoute()
...
val AppRoute.rootRoute: AppRoute
    get() = when (this) {
        is AppRoute.Post, is AppRoute.PostList, is AppRoute.PostViewer, is AppRoute.PostSearch -> AppRoute.Post()
        AppRoute.Pool, AppRoute.PoolList, is AppRoute.PoolPost, is AppRoute.PoolViewer -> AppRoute.Pool
        AppRoute.Popular, AppRoute.PopularList, is AppRoute.PopularViewer -> AppRoute.Popular
